...
### CUDA_VISIBLE_DEVICES=0,2,3,7 python3 -m fastchat.serve.model_worker --controller-address http://localhost:11001 --model-path /data/workspace/huangyuting/meta-llama/Llama-2-13b-chat-hf/ --port 11002 --num-gpus 4 --max-gpu-memory 9GiB
openai.api_key = "EMPTY"
model = "gemma-7b"
# openai.base_url = "http://127.0.0.1:11003/v1/"
def make_requests(
        engine, prompts, max_tokens, temperature, top_p, 
        frequency_penalty, presence_penalty, stop_sequences, logprobs, n, best_of, retries=500, api_key=None, organization=None,url = "http://127.0.0.1:11003/v1/"
    ):
    response = None
    ...
    while retry_cnt <= retries:
        try:
            # print('11111')
            # print(retry_cnt)
            # response = openai.completions.create(model=model, prompt = "Once upon a time", max_tokens=64)
    ...
    # print(response)
    # print('123123123333333333333333333333333333333333333333')
    # print(type(response))

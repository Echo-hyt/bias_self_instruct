...
def parse_instances_for_generation_task(raw_text, instruction, response_metadata):
    ...
    # print(response_metadata["response"]["choices"][0].finish_reason)
    # print('111111111111111111111111111111111111111111111111111111111111111111')
    if "finish_reason" in response_metadata["response"]["choices"][0] and response_metadata["response"]["choices"][0]['finish_reason'] == "length":

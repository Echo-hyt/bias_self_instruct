...
parser.add_argument("--controller-port", type=int, default=6006)
parser.add_argument(
    "--dispatch-method",
    type=str,
...
parser.add_argument("--worker-port", type=int, default=11002)
# parser.add_argument("--worker-address", type=str, default="http://localhost:11002")
# parser.add_argument(
#     "--controller-address", type=str, default="http://localhost:11002"
# )
parser.add_argument(
    "--model-path",
    type=str,
...
parser.add_argument("--server-port", type=int, default=11001, help="port number")
parser.add_argument(

...
class AppSettings(BaseSettings):
    ...
    controller_address: str = "http://localhost:6006"
...
def create_openai_api_server():
    ...
    parser.add_argument("--port", type=int, default=11001, help="port number")
    parser.add_argument(
        "--controller-address", type=str, default="http://localhost:6006"
    )
    parser.add_argument(
